...
client.on("message", async message => {
  ...
  if (message.channel.type === "dm" && (koruma == null || koruma == undefined || koruma == false)) {
    ...
    let embed = new Discord.MessageEmbed().setColor("RANDOM").addField(" Yeni Öneri!", `${message.content ? message.content.slice(0, 900) : ""}\n\n<a:Galaxy_sag:823964450687418429>\`Öneriyi Yapan:\` ${message.author}`);
